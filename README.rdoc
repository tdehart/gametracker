...
* Users can follow games/tournaments (done)
* Users can view their feed of followed games/tournaments (back-end done)
* Users can view all Tournaments/Events (index, show pages) (back-end done)
* Users can view streams and the site will update streams to keep a current list of live streams (mostly done)
* Admins can submit new content (done)
* Track contributions (done)
...
* Users can submit data like brackets/results/VODs to existing tournaments
...
== Phase 4
* Streamline new content submission so that the site works by itself (submission voting?)
